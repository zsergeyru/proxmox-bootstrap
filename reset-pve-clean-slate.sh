...
remove_project_files() {
    ...
    for path in         /root/.config/proxmox-bootstrap         /etc/proxmox-deployer         /var/lib/proxmox-deployer         /var/lib/pvedeploy         /var/log/proxmox-deployer         /etc/infra-manager         /var/lib/infra-manager         /opt/infra-manager         /run/proxmox-bootstrap         /var/backups/proxmox-bootstrap         /var/backups/proxmox-configuration         /var/backups/proxmox-secrets
    do
...
print_bootstrap_entrypoint() {
    local url="https://raw.githubusercontent.com/zsergeyru/proxmox-bootstrap/rename-infra-manager/bootstrap-pve.sh"
